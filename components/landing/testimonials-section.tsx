...
const testimonials = [
  {
    quote:
      "Aeghin completely transformed how we manage our worship team. We went from chaotic group chats to a seamless scheduling system. Our volunteers actually know when they're serving now!",
  ...
  {
    quote:
      "We tried three other platforms before Aeghin. Nothing else understood the unique needs of worship teams. The role-based system for musicians is exactly what we needed.",
    author: "David Park",
    role: "Senior Pastor",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-20">
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            Join thousands of churches and organizations who trust Aeghin.
          </p>
        </div>
